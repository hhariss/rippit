...
<body>
    ...
    ?>
    <form class="container col-7 font-monospace" method="post" action="../php/resolves_page_result.php">
        <div class="form-group mt-3">
            <h1>resolves</h1>
            <label>list of admins</label>
            <select name="user" class="form-control">
                <?php
            $result = mysqli_query($conn, "SELECT * FROM Admins");
            echo "<option value='' disabled selected hidden>choose admin</option>";
